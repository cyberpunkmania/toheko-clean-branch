...
import { z } from "zod";
import { Wallet, Mail, KeyRound, Lock, Eye, EyeOff, ArrowLeft } from "lucide-react";
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 via-purple-600 to-purple-700 flex items-center justify-center text-white shadow-lg shadow-purple-500/30">
        ...
        <Card className="shadow-2xl border-0 overflow-hidden">
          ...
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {step === 1
                ? "Enter your loanee email to receive an OTP"
                : step === 2
...
export default LoaneeForgotPassword;
