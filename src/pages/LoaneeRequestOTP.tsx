          ...
          <CardContent className="px-6 py-8">
            {!isOtpSent ? (
              <>
                ...
                <div className="text-center mb-6">
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                    <span className="text-purple-600">Request</span> OTP
                  </h1>
                  {fromLogin ? (
                    <p className="text-sm text-gray-600">
                      Your account requires <span className="font-semibold text-purple-600">OTP verification</span>
                    </p>
                  ) : (
                    <p className="text-sm text-gray-600">
                ...
                <form onSubmit={handleSendOTP} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full h-12 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group"
                  >
                    {isSending ? (
                      <>
              ...
              <>
                ...
                <div className="text-center mb-6">
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                    <span className="text-purple-600">Verify</span> OTP
                  </h1>
                ...
                <Button
                  ...
                  className="w-full h-12 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed mb-4"
                >
                  {isVerifying ? (
                    <>
                      <Loader2 className="mr-2 h-5 w-5 animate-spin" />
...
export default LoaneeRequestOTP;
