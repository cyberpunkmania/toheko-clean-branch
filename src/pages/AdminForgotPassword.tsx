...
import { z } from "zod";
import { Shield, Mail, KeyRound, Lock, Eye, EyeOff, ArrowLeft } from "lucide-react";
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 flex items-center justify-center text-white shadow-lg shadow-blue-500/30">
